...
pd <- copy(csmaps::nor_nuts3_map_b2020_insert_oslo_dt)
...
q <- q + geom_label(
  data = csmaps::nor_nuts3_position_geolabels_b2020_default_dt,
...
# join, create label
labels <- copy(csmaps::nor_nuts3_position_geolabels_b2020_insert_oslo_dt)
labels[
  dpop_2020, 
  on = "location_code",
  pop_total := pop_total
