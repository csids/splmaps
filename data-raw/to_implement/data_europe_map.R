...
# #' q <- q + geom_polygon(data = fhidata::europe_map_nuts0, color = "black", fill = "white", linewidth = 0.4)
# #' q <- q + theme_void()
# #' q <- q + coord_map(
...
# #' library(ggplot2)
# #' q <- ggplot(mapping = aes(x = long, y = lat, group = group))
# #' q <- q + geom_polygon(data = fhidata::europe_map_nuts1, color = "black", fill = "white", linewidth = 0.4)
# #' q <- q + theme_void()
# #' q <- q + coord_map(
# #'   projection = "cylequalarea",
# #'   xlim = c(-25, 50),
...
# #' library(ggplot2)
# #' q <- ggplot(mapping = aes(x = long, y = lat, group = group))
# #' q <- q + geom_polygon(data = fhidata::europe_map_nuts2, color = "black", fill = "white", linewidth = 0.4)
# #' q <- q + theme_void()
# #' q <- q + coord_map(
# #'   projection = "cylequalarea",
# #'   xlim = c(-25, 50),
...
# #' library(ggplot2)
# #' q <- ggplot(mapping = aes(x = long, y = lat, group = group))
# #' q <- q + geom_polygon(data = fhidata::europe_map_nuts3, color = "black", fill = "white", linewidth = 0.4)
# #' q <- q + theme_void()
# #' q <- q + coord_map(
# #'   projection = "cylequalarea",
# #'   xlim = c(-25, 50),
